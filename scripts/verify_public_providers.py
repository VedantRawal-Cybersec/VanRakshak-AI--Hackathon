...
from app.adapters import (
    ...
    NominatimAdapter, PhotonAdapter, GIBSAdapter, EONETAdapter, OverpassAdapter, GDELTAdapter, GFWAdapter, NASAPowerAdapter,
)
...
async def main():
    ...
    gibs=GIBSAdapter(); eonet=EONETAdapter(); overpass=OverpassAdapter(); gdelt=GDELTAdapter(); gfw=GFWAdapter(); power=NASAPowerAdapter()
    ...
    core={"Earth Search Sentinel-2","Open-Meteo","NASA GIBS","NASA EONET","NASA POWER"}
