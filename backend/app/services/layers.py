LAYER_GROUPS = [
    {"id":"satellite","label":"Satellite Imagery","icon":"🛰️","layers":[
        ...
        {"id":"nasa_viirs_snpp","label":"NASA VIIRS S-NPP True Color","source":"NASA GIBS","freshness":"DYNAMIC_RECENT","resolution_m":250,"render":"gibs","gibs_layer":"viirs_snpp_true_color"},
    ...
    {"id":"vegetation","label":"Vegetation","icon":"🌿","layers":[
        ...
        {"id":"nasa_modis_ndvi","label":"NASA MODIS NDVI 8-Day","source":"NASA GIBS","freshness":"DYNAMIC_RECENT","resolution_m":250,"render":"gibs","gibs_layer":"modis_terra_ndvi_8day"},
    ...
    {"id":"fire","label":"Fire","icon":"🔥","layers":[
        ...
        {"id":"nasa_viirs_thermal","label":"NASA VIIRS Thermal Anomalies","source":"NASA GIBS","freshness":"DYNAMIC_RECENT","resolution_m":375,"render":"gibs","gibs_layer":"viirs_snpp_thermal_anomalies"},
    ...
    {"id":"climate","label":"Climate & Weather","icon":"🌡️","layers":[
        ...
        {"id":"nasa_modis_lst","label":"NASA MODIS Land Surface Temperature","source":"NASA GIBS","freshness":"DYNAMIC_RECENT","resolution_m":1000,"render":"gibs","gibs_layer":"modis_terra_lst_day"},
        {"id":"rainfall","label":"Rainfall","source":"Open-Meteo / CHIRPS","freshness":"FORECAST","render":"point_data"},
        {"id":"nasa_imerg_rain","label":"NASA GPM IMERG Precipitation","source":"NASA GIBS","freshness":"DYNAMIC_RECENT","resolution_m":10000,"render":"gibs","gibs_layer":"imerg_precipitation_rate"},
