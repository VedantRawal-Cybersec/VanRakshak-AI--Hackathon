...
| 2 | Forest Cover Monitoring | `WORKING_WITH_PUBLIC_FALLBACK` | /api/layers<br>/api/earth-engine/layer/dynamic_world_trees |
...
- `WORKING_WITH_PUBLIC_FALLBACK` — the product function remains usable through a labelled public fallback; optional authenticated sources can improve precision, coverage or metadata richness.
